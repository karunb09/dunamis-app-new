        ...
        <div className="flex items-start justify-between gap-4 border-b border-slate-100 p-6">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              This square crop is used for profile cards, course pages, and
              dashboard avatars.
            </p>
          </div>
          <button
          ...
          <div className="space-y-5">
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
              <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-slate-800">
                <FaCompressArrowsAlt className="text-orange-500" />
                Crop controls
              </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <button
                ...
                onClick={handleApply}
                disabled={isApplying}
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
              >
                <FaCheck />
