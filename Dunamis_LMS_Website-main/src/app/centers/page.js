...
import { MapPin, Phone, Clock, ChevronRight, Building2 } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4 gap-3">
        ...
        >
          View Centre <ChevronRight className="w-4 h-4" />
        </Link>
      </div>
    </motion.div>
  );
    ...
    <>
      ...
      <div className="relative overflow-hidden bg-[#09090f] rounded-b-[52px]">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 py-24 text-center">
          ...
          >
            <Building2 className="w-4 h-4" /> Experience Learning in Person
          </motion.span>
