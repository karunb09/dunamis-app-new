  ...
  return (
    <div className="min-h-screen bg-[#fffaf4]">
      ...
      <div className="relative h-72 md:h-96 lg:h-[430px] overflow-hidden">
        ...
        >
          <ChevronLeft className="w-4 h-4" /> All Centres
        </Link>
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 space-y-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          <InfoCard icon={<MapPin className="w-5 h-5" />} label="Address" value={address} />
          <InfoCard icon={<Clock className="w-5 h-5" />} label="Hours" value={openingHours} />
          <InfoCard icon={<Users className="w-5 h-5" />} label="Capacity" value={capacity} />
          <InfoCard icon={<Phone className="w-5 h-5" />} label="Phone" value={contactPhone} />
          <InfoCard icon={<Mail className="w-5 h-5" />} label="Email" value={email} />
        </div>
