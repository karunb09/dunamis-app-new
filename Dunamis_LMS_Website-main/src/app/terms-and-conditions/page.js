...
const terms = [
  ...
  "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Nagaram, Telangana.",
...
export default function TermsAndConditionsPage() {
  return (
    <LegalPolicyPage
      ...
      updatedAt="28-04-2026 07:15:17"
      downloadHref="/DMPL-Website-Terms-Conditions.pdf"
      downloadLabel="Download Terms PDF"
      intro="These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between DUNAMIS MUSIC PRIVATE LIMITED (“Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”)."
    >
      <Section>
        <p>
